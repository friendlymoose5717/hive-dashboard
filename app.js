...
async function getPendingPayouts(user) {
    try {
        ...
        console.warn("Pending payouts timeout or error → skipping", e);
        return { hp: 0, hbd: 0 };
    }
}
...
async function checkUser() {
    ...
    dash.innerHTML = `
        <div class="grid">
            ...
            <div class="card loading" id="pendingCard"><div class="label">Pending payouts (7d)</div><div class="value">Loading…</div></div>
    ...
    const pendingStatus = pending.hp > 200 ? "warning" : "ok";
    setCard(
        "pendingCard",
